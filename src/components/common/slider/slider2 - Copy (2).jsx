...
class CarouselPage1 extends Component {
  constructor(props) {
    ...
    this.data = [
      {
        image: `/assets/imagewebp/project/billiards.jpg`,
        title: ``,
        // description: 'Set in Budva, Post Office Center Apartments features accommodation with a seating area and a kitchen.',
        link: "#",
      },
      {
        image: `/assets/imagewebp/project/gym.jpg`,
        title: ``,
        // description: 'Set in Budva, Post Office Center Apartments features accommodation with a seating area and a kitchen.',
        link: "#",
      },
      {
        image: `/assets/imagewebp/project/theatre.jpg`,
        title: ``,
        // description: 'Set in Budva, Post Office Center Apartments features accommodation with a seating area and a kitchen.',
        link: "#",
      },
      {
        image: `/assets/imagewebp/project/party-hall.jpg`,
        title: ``,
        // description: 'Set in Budva, Post Office Center Apartments features accommodation with a seating area and a kitchen.',
        link: "#",
      },
